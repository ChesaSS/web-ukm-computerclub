  ...
  function StackedCarousel2(props) {
    ...
    _this.initializeProperties = function(constructor) {
      ...
      var _loop = function _loop2(absIndex2) {
        ...
        if (absIndex2 !== 0) filledWidth += scaledOffsets[absIndex2];
      };
    ...
    _this.onSwipeStart = function(e) {
      ...
      if (_this.centerOffset(-1) < _this.centerOffset(0)) shiftDirection = 1;
      else if (_this.centerOffset(1) < _this.centerOffset(0)) shiftDirection = -1;
